<template>
  <nav class="navbar">
      ...
      <ul class="navbar-links">
        ...
        <li>
          <router-link to="/add-order" class="nav-link"
            ><LucidePlusCircle class="icon" /> Tambah</router-link
          >
        </li>
      </ul>
    ...
    <transition name="fade">
      <div v-if="isMenuOpen" class="navbar-mobile-links">
        <ul>
          <li>
          ...
          <li>
            <router-link to="/add-order" @click="closeMenu" class="nav-link"
              ><LucidePlusCircle class="icon" /> Tambah</router-link
            >
          </li>
        </ul>
...
.navbar-mobile-links {
  ...
  right: 0;
  padding: 12px 24px;
  box-shadow: inset 0 -1px 0 #222831;
  position: absolute;
  margin-top: 15px;
}
...
.navbar-mobile-links ul li a:hover {
  color: #00adb5;
}
...
.navbar-mobile-links ul li .router-link-exact-active {
  color: #00adb5;
  font-weight: bold;
